        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">
                    Sistem Informasi Pendaftaran Skripsi Mahasiswa
                </h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                    Sistem yang berfungsi untuk pendaftaran Skripsi dari Mahasiswa.
                </p>
                <div class="flex gap-3 text-sm leading-normal">
                    @auth
                        <a href="{{ auth()->user()->role->name == 'admin' ? route('admin.dashboard') : route('mahasiswa.dashboard') }}"
